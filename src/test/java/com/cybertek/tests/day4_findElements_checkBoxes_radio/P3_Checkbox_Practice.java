...
public class P3_Checkbox_Practice {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if ( !checkbox1.isSelected() ){
            System.out.println("Checkbox 1 is not selected. Verification passes!!");
        }else{
        ...
        if ( checkbox2.isSelected() ){
            System.out.println("Checkbox 2 is selected. Verification passes!!");
        }else{
        ...
        if (checkbox1.isSelected()){
            System.out.println("Checkbox 1 is selected. Verification passes!!");
        }else{
        ...
        if (!checkbox2.isSelected()){
            System.out.println("Checkbox 2 is not selected. Verification passes!!");
        }else{
